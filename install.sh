...
wget https://github.com/siddharthapriya/Termux_XFCE/raw/main/xfce.sh
wget https://github.com/siddharthapriya/Termux_XFCE/raw/main/proot.sh
wget https://github.com/siddharthapriya/Termux_XFCE/raw/main/utils.sh
chmod +x *.sh
